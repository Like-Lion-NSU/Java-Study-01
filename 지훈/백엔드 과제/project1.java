...
//
        ...
        }   if (money%50000/10000 >= 0 ) {
            System.out.println("만원권" + money%50000/10000 + "장");
        }   if (money%50000%10000/1000 >= 0 ) {
            System.out.println("천원권" + money%50000%10000/1000 + "장");
        }   if (money%50000%10000%1000/500 >= 0 ) {
            System.out.println("오백원" + money%50000%10000%1000/500 + "개");
        }   if (money%50000%10000%1000%500/100 >= 0 ) {
            System.out.println("백원" + money%50000%10000%1000%500/100 + "개");
        }   if (money%50000%10000%1000%500%100/50 >= 0 ) {
            System.out.println("오십원" + money%50000%10000%1000%500%100/50 + "개");
        }   if (money%50000%10000%1000%500%100%50/10 >= 0 ) {
            System.out.println("십원" + money%50000%10000%1000%500%100%50/10 + "개");
        }   if (money%50000%10000%1000%500%100%50%10/1 >= 0 ) {
            System.out.println("일원" + money%50000%10000%1000%500%100%50%10/1 + "개");
        }
